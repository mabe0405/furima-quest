...
ActiveRecord::Schema.define(version: 2021_02_02_100129) do
  ...
  create_table "abilities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "weapon_id", default: 0, null: false
    t.integer "shield_id", default: 0, null: false
  ...
  create_table "fgems", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "gem", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_fgems_on_user_id"
  end
